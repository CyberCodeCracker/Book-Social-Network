...
import { findAllBurrowedBooks } from '../fn/book/find-all-burrowed-books';
import { FindAllBurrowedBooks$Params } from '../fn/book/find-all-burrowed-books';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `findAllBurrowedBooks()` */
  static readonly FindAllBurrowedBooksPath = '/books/burrowed';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findAllBurrowedBooks()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllBurrowedBooks$Response(params?: FindAllBurrowedBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBorrowedBookResponse>> {
    return findAllBurrowedBooks(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findAllBurrowedBooks$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
